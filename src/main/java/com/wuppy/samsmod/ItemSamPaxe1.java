...
public class ItemSamPaxe1 extends ItemTool 
{
	...
	public ItemSamPaxe1(ToolMaterial material, String name)
	{	
    ...
    public boolean func_150897_b(Block block)
    {
        return block ==
        		...
        		Blocks.redstone_ore && block != Blocks.lit_redstone_ore ? (block.getMaterial() == Material.rock ? 
        		true : (block.getMaterial() == Material.iron ? true : block.getMaterial() == Material.anvil)) : 
